{block name='snippets-consent-manager'}
    <div id="consent-manager" class="hidden">
        ...
        {block name='snippets-consent-manager-button'}
            <button type="button" class="consent-btn consent-btn-outline-primary hidden" id="consent-settings-btn"
                                ...
                                <div class="consent-btn-helper">
                                    <div class="consent-accept">
                                        <button type="button" class="consent-btn consent-btn-outline-primary btn-block"
                                                id="consent-banner-btn-all" tabindex="1">
                                            {lang key='consentAll' section='consent'}
                                        </button>
                                    </div>
                                    <div>
                                        <button type="button" class="consent-btn consent-btn-outline-primary btn-block"
                                                id="consent-banner-btn-settings" tabindex="1">
                                    ...
                                    <div>
                                        <button type="button"
                                                ...
                                                id="consent-banner-btn-close" tabindex="1"
