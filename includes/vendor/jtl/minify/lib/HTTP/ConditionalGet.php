...
class HTTP_ConditionalGet
{
    ...
    public function __construct($spec)
    {
        ...
        if (isset($spec['encoding'])) {
            ...
            if ('' !== $spec['encoding']) {
                ...
                if (str_starts_with($spec['encoding'], 'x-')) {
        ...
        $this->cacheIsValid = !(isset($spec['invalidate']) && $spec['invalidate']) && $this->_isCacheValid();
    }
    ...
    public function sendHeaders(): void
    {
        ...
        if (array_key_exists('_responseCode', $headers)) {
            ...
            [, $code] = explode(' ', $headers['_responseCode'], 3);
    ...
    protected function resourceMatchedEtag()
    {
        ...
        foreach (explode(',', $clientEtagList) as $clientEtag) {
    ...
    protected function resourceNotModified()
    {
        ...
        [$ifModifiedSince] = explode(';', $_SERVER['HTTP_IF_MODIFIED_SINCE'], 2);
