...
class HTTP_Encoder
{
    ...
    public static function getAcceptedEncoding($allowCompress = true, $allowDeflate = true)
    {
        ...
        // gzip checks (quick)
        if (
            str_starts_with($ae, 'gzip,')             // most browsers
        ...
        if ($allowDeflate) {
            ...
            $aeRev = strrev($ae);
            if (
                str_starts_with($aeRev, 'etalfed ,') // ie, webkit
    ...
    public static function isBuggyIe()
    {
        ...
        if (
            !str_starts_with($ua, 'Mozilla/4.0 (compatible; MSIE ')
