...
class Minify_LessCssSource extends Minify_Source
{
    ...
    private function getCache()
    {
        ...
        // so that getLastModified and getContent in single request do not add
        // additional cache roundtrips (i.e memcache)
        ...
        if ($this->cache->isValid($cacheId, 0) && $cache = $this->cache->fetch($cacheId)) {
