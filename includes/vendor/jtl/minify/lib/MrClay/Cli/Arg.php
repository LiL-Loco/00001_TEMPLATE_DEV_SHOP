 ...
 *
 * @method Arg mayHaveValue() Assert that the argument, if present, may receive a string value
 * @method Arg mustHaveValue() Assert that the argument, if present, must receive a string value
 * @method Arg assertFile() Assert that the argument's value must specify a file
 * @method Arg assertDir() Assert that the argument's value must specify a directory
 * @method Arg assertReadable() Assert that the specified file/dir must be readable
 * @method Arg assertWritable() Assert that the specified file/dir must be writable
 *
