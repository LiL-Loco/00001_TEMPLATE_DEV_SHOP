...
class ControllerFactory
{
    ...
    private function fail(ServerRequestInterface $request): ControllerInterface
    {
        ...
        if (!$this->state->linkID) {
            $hookInfos = $this->urlNotFoundRedirect([
                'key'   => 'kLink',
    ...
    /**
     * @return class-string<ControllerInterface>|null
     */
