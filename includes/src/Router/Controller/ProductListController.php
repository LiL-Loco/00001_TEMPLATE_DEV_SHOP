...
class ProductListController extends AbstractController
{
    ...
    public function init(): bool
    {
        ...
        if (
            ...
            && (int)$this->config['global']['global_sichtbarkeit'] === 3
    ...
    public function getResponse(ServerRequestInterface $request, array $args, JTLSmarty $smarty): ResponseInterface
    {
        ...
        if ($this->productFilter->hasCategory() && $this->currentCategory !== null) {
        ...
        $this->searchResults->getProducts()->transform(function (Artikel $product): Artikel {
    ...
    protected function checkProductRedirect(): ?ResponseInterface
    {
        ...
        $categoryID       = $this->productFilter->getCategory()->getValue();
        $hasSubCategories = \is_int($categoryID)
            && $categoryID > 0
    ...
    protected function assignBestsellers(): void
    {
        ...
        $productsIDs = $this->searchResults->getProducts()->map(static function (Artikel $product): int {
