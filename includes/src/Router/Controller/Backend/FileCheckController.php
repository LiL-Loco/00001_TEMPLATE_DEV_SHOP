...
use JTL\Backend\StatusCheck\OrphanedFiles;
...
class FileCheckController extends AbstractBackendController
{
    ...
    public function getResponse(ServerRequestInterface $request, array $args, JTLSmarty $smarty): ResponseInterface
    {
        ...
        $this->cache->flush(ModifiedFiles::CACHE_ID_MODIFIED_FILE_STRUCT);
        $this->cache->flush(OrphanedFiles::CACHE_ID_ORPHANED_FILE_STRUCT);
