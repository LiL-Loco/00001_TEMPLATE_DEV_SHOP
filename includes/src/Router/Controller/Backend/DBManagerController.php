...
class DBManagerController extends AbstractBackendController
{
    ...
    public function getResponse(ServerRequestInterface $request, array $args, JTLSmarty $smarty): ResponseInterface
    {
        ...
        switch (true) {
            case isset($_GET['table']) && $valid:
                return $this->actionGetTable(Request::gString('table'));

            case isset($_GET['select']) && $valid:
                return $this->actionSelect(Request::gString('select'));
    ...
    private function actionQuery(): ResponseInterface
    {
        ...
        if (isset($_POST['query'])) {
            $query = Request::pString('query');
        } elseif (isset($_POST['sql_query_edit'])) {
            $query = Request::pString('sql_query_edit');
        }
        if ($query !== null) {
            try {
            ...
            $this->getSmarty()->assign('query', Text::filterXSS(Request::gString('query')));
        }
