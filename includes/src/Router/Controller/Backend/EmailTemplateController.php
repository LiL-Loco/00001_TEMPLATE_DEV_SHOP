...
use JTL\Backend\StatusCheck\EmailSyntaxUnchecked;
...
class EmailTemplateController extends AbstractBackendController
{
    ...
    public function getResponse(ServerRequestInterface $request, array $args, JTLSmarty $smarty): ResponseInterface
    {
        ...
        $this->cache->flushTags([EmailSyntaxUnchecked::CACHE_ID_EMAIL_SYNTAX_CHECK]);
        ...
        if (
            ...
            && Request::postInt('resetConfirmJaSubmit') === 1
            && Request::postInt('resetConfirmNeinSubmit') !== 1
        ) {
        ...
        if (
            ...
            if (
                ...
                && Request::gString('token') === $_SESSION['jtl_token']
