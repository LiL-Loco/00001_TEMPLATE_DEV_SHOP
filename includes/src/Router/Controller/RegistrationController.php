...
class RegistrationController extends PageController
{
    ...
    public function getResponse(ServerRequestInterface $request, array $args, JTLSmarty $smarty): ResponseInterface
    {
        ...
        if (isset($_POST['editRechnungsadresse'])) {
            $edit = Request::pInt('editRechnungsadresse');
        }
    ...
    public function saveCustomer(array $post): array|int
    {
        ...
        if ($nReturnValue) {
            ...
            if ($edit && $_SESSION['Kunde']->kKunde > 0) {
                ...
                $_SESSION['Kunde']->getCustomerAttributes()->load($_SESSION['Kunde']->getID());
            } else {
                ...
                $customerData->angezeigtesLand   = LanguageHelper::getCountryCodeByCountryName(
                    $customerData->cLand ?? 'DE'
                );
