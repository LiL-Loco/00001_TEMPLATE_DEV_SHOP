...
class Reset
{
    ...
    public function doReset(ResetContentType $contentType): self
    {
        ...
        switch ($contentType) {
            case ResetContentType::PRODUCTS():
                $this->resetProducts();
                break;
            case ResetContentType::TAXES():
                $this->resetTaxes();
                break;
            case ResetContentType::REVISIONS():
                $this->db->query('TRUNCATE trevisions');
                break;
            case ResetContentType::NEWS():
                $this->resetNews();
                break;
            case ResetContentType::BESTSELLER():
                $this->db->query('TRUNCATE tbestseller');
                break;
            case ResetContentType::STATS_VISITOR():
                $this->resetVisitorStats();
                break;
            case ResetContentType::STATS_PRICES():
                $this->db->query('TRUNCATE tpreisverlauf');
                break;
            case ResetContentType::MESSAGES_AVAILABILITY():
                $this->db->query('TRUNCATE tverfuegbarkeitsbenachrichtigung');
                break;
            case ResetContentType::SEARCH_REQUESTS():
                $this->resetSearchRequests();
                break;
            case ResetContentType::RATINGS():
                $this->resetRatings();
                break;
            case ResetContentType::WISHLIST():
                $this->resetWishList();
                break;
            case ResetContentType::COMPARELIST():
                $this->db->query('TRUNCATE tvergleichsliste');
                $this->db->query('TRUNCATE tvergleichslistepos');
                break;
            case ResetContentType::CUSTOMERS():
                $this->resetCustomers();
                break;
            case ResetContentType::ORDERS():
                $this->resetOrders();
                break;
            case ResetContentType::COUPONS():
                $this->resetCoupons();
                break;
            case ResetContentType::SETTINGS():
                $this->resetSettings();
                break;
        }
