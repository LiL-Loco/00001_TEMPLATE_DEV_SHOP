...
class ProductImage
{
    ...
    /**
     * @var object&stdClass{
     * 'xs': object{src: string, size: object{width: int, height: int} type: string, alt: string}&stdClass,
     * 'sm': object{src: string, size: object&stdClass{width: int, height: int} type: string, alt: string}&stdClass,
     * 'md': object{src: string, size: object&stdClass{width: int, height: int} type: string, alt: string}&stdClass,
     *  'lg': object{src: string, size: object&stdClass{width: int, height: int} type: string, alt :string}&stdClass}
     */
