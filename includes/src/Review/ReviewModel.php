 ...
 * @method int getId()
 * @method Collection<ReviewHelpfulModel> getVotes()
 * @method Collection<ReviewBonusModel> getBonus()
 * @property DateTime|string                $date
 * @property string                         $answer
 * @property DateTime|string                $answerDate
 * @property Collection<ReviewHelpfulModel> $votes
 * @property Collection<ReviewBonusModel>   $bonus
 */
