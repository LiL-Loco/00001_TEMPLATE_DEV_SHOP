...
class IOMethods
{
     ...
     * @throws SmartyException
     */
    public function pushToBasket(int $productID, float|int|string $amount, array|string $properties = ''): IOResponse
    {
