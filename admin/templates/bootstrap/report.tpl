                            ...
                            <tr>
                                ...
                                <td>
                                    <button name="download"
                                            {if $report->fileExists === false} disabled{/if}
                                            value="{$report->id}"
                                            class="btn btn-link px-1 dl notext"
                                            title="{__('Download')}"
                                            data-toggle="tooltip"
                                            data-placement="top">
                                    ...
                                    <button name="share"
                                            value="{$report->id}"
                                            {if $report->fileExists === false} disabled{/if}
                                            class="btn btn-link px-1 share notext"
                                            title="{__('Share')}"
                                            data-toggle="tooltip"
                                            data-placement="top">
                                        <span class="icon-hover">
                                    ...
                                    <button name="delete"
                                            value="{$report->id}"
                                            class="btn btn-link px-1 delete notext"
                                            title="{__('Delete')}"
                                            data-toggle="tooltip"
                                            data-placement="top">
                                        <span class="icon-hover">
