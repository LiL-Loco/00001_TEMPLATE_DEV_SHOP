    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="last_order">
                <div class="row">
                    <div class="col-auto">{__('Order number')}:</div>
                    <div class="col"><strong>{$oBestellung->cBestellNr}</strong></div>
                </div>
                <div class="row">
                    <div class="col-auto">{__('Order date')}:</div>
                    <div class="col"><strong>{$oBestellung->dErstelldatum_de}</strong></div>
                </div>
            </div>
