                ...
                <div class="card-footer save-wrapper">
                    <div class="row">
                        <div class="col-sm-6 col-xl-auto text-left">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input"
                                       type="checkbox"
                                       name="ALLMSGS"
                                       id="ALLMSGS_{$cKuponTyp}"
                                       onclick="AllMessages(this.form);">
                                <label class="custom-control-label" for="ALLMSGS_{$cKuponTyp}">
                                    {__('globalSelectAll')}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="{if count($oKupon_arr) === 0}ml-auto{/if} col-sm-6 col-xl-auto">
                            {include file='tpl_inc/csv_import_btn.tpl'
                            importerId="kupon_{$cKuponTyp}"
                            importerType="kupon"}
                        </div>
                        <div class="col-sm-6 col-xl-auto">
    ...
    <div class="tabs">
        <nav class="tabs-nav">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link {if $tab === $couponTypes.standard} active{/if}"
                       data-toggle="tab"
                       role="tab"
                       href="#{$couponTypes.standard}"
                       aria-expanded="false">
                        {__('standardCoupon')}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {if $tab === $couponTypes.shipping} active{/if}"
                       data-toggle="tab"
                       role="tab"
                       href="#{$couponTypes.shipping}"
                       aria-expanded="false">
                        {__('shippingCoupon')}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {if $tab === $couponTypes.newCustomer} active{/if}"
                       data-toggle="tab"
                       role="tab"
                       href="#{$couponTypes.newCustomer}"
                       aria-expanded="false">
