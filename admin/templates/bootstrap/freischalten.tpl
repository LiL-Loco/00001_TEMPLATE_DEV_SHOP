...
cTitel=__('freischalten')
cBeschreibung=__('freischaltenDesc')
cDokuURL=__('freischaltenURL')}
<div id="content">
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="ml-auto col-sm-6 col-xl-auto">
                    <form name="suche" method="post" action="{$adminURL}{$route}">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xl-auto mb-sm-0 mb-3">
                                <div class="form-row">
                                    <label class="col-sm-auto col-form-label" for="search_type">
                                        {__('freischaltenSearchType')}:
                                    </label>
                                    <span class="col-sm-auto">
                                        <select class="custom-select" name="cSuchTyp" id="search_type">
                                            <option value="Bewertung"{if isset($cSuchTyp) && $cSuchTyp === 'Bewertung'} selected{/if}>
                                                {__('reviews')}
                                            </option>
                                            <option value="Livesuche"{if isset($cSuchTyp) && $cSuchTyp === 'Livesuche'} selected{/if}>
                                                {__('freischaltenLivesearch')}
                                            </option>
                                            <option value="Newskommentar"{if isset($cSuchTyp) && $cSuchTyp === 'Newskommentar'} selected{/if}>
                                                {__('freischaltenNewsComments')}
                                            </option>
                                            <option value="Newsletterempfaenger"{if isset($cSuchTyp) && $cSuchTyp === 'Newsletterempfaenger'} selected{/if}>
                                                {__('freischaltenNewsletterReceiver')}
                                            </option>
                                        </select>
                                    </span>
                                </div>
                            ...
                            <div class="col-sm-6 col-xl-auto mb-sm-0 mb-3">
                                ...
                                <div class="form-row">
                                    <label for="search_key" class="col-sm-auto col-form-label sr-only">
                                        {__('freischaltenSearchItem')}
                                    </label>
                                    <span class="col-sm-auto mb-sm-0 mb-3">
                                        <input class="form-control"
                                               name="cSuche"
                                               type="text"
                                               value="{if isset($cSuche)}{$cSuche}{/if}"
                                               id="search_key"
                                               placeholder="{__('freischaltenSearchItem')}">
                                    </span>
                                    <div class="col-sm-auto">
                                        <button name="submitSuche"
                                                value="1"
                                                type="submit"
    ...
    <div class="tabs">
        <nav class="tabs-nav">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link {if $cTab === '' || $cTab === 'bewertungen'} active{/if}"
                       data-toggle="tab"
                       role="tab"
                       href="#bewertungen">
                ...
                <li class="nav-item">
                    <a class="nav-link {if $cTab === 'livesearch'} active{/if}"
                       data-toggle="tab"
                       role="tab"
                       href="#livesearch">
                ...
                <li class="nav-item">
                    <a class="nav-link {if $cTab === 'newscomments'} active{/if}"
                       data-toggle="tab"
                       role="tab"
                       href="#newscomments">
                ...
                <li class="nav-item">
                    <a class="nav-link {if $cTab === 'newsletter'} active{/if}"
                       data-toggle="tab"
                       role="tab"
                       href="#newsletter">
                                            ...
                                            <td class="check">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                           name="kBewertung[]"
                                                           type="checkbox"
                                                           id="review-id-{$rating->kBewertung}"
                                                           value="{$rating->kBewertung}" />
                                                    <label class="custom-control-label"
                                                           for="review-id-{$rating->kBewertung}"></label>
                                                </div>
                                                <input type="hidden" name="kArtikel[]" value="{$rating->kArtikel}" />
                                                <input type="hidden" name="kBewertungAll[]" value="{$rating->kBewertung}" />
                                            </td>
                                            <td>
                                                <a href="{$shopURL}/?a={$rating->kArtikel}" target="_blank">
                                                    {$rating->ArtikelName}
                                                </a>
                                            </td>
                                            <td>{$rating->cName}.</td>
                            ...
                            <div class="save-wrapper">
                                <div class="row">
                                    <div class="col-sm-6 col-xl-auto text-left">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" name="ALLMSGS"
                                                   id="ALLMSGS1"
                                                   type="checkbox"
                                                   onclick="AllMessages(this.form);" />
                                            <label class="custom-control-label" for="ALLMSGS1">
                                                {__('globalSelectAll')}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="ml-auto col-sm-6 col-xl-auto">
                                        <button name="freischaltenleoschen"
                                                value="1"
                                                type="submit"
                                    ...
                                    <div class="col-sm-6 col-xl-auto">
                                        <button name="freischaltensubmit"
                                                value="1"
                                                type="submit"
                                                class="btn btn-primary btn-block">
                    ...
                    <div>
                        <form method="post" action="{$adminURL}{$route}">
                            ...
                            {if isset($cSuche) && isset($cSuchTyp) && $cSuche && $cSuchTyp}
                                {$cSuchStr = 'Suche=1&cSuche='|cat:$cSuche|cat:'&cSuchTyp='|cat:$cSuchTyp|cat:'&'}
                            {else}
                                {$cSuchStr = ''}
                            {/if}
                            <div class="table-responsive">
                                <table class="list table table-striped">
                                    ...
                                    <tr>
                                        <th class="check">&nbsp;</th>
                                        <th class="text-left">(<a href="{$adminURL}{$route}?tab=livesearch&{$cSuchStr}nSort=1{if !isset($nSort) || $nSort != 11}1{/if}&token={$smarty.session.jtl_token}" style="text-decoration: underline;">{if !isset($nSort) || $nSort != 11}Z...A{else}A...Z{/if}</a>) {__('freischaltenLivesearchSearch')}</th>
                                            ...
                                            <td class="check">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                           name="kSuchanfrage[]"
                                                           type="checkbox"
                                                           id="search-request-id-{$query->kSuchanfrage}"
                                                           value="{$query->kSuchanfrage}" />
                                                    <label class="custom-control-label"
                                                           for="search-request-id-{$query->kSuchanfrage}"></label>
                                                </div>
                                            </td>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xl-auto text-left">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input"
                                                   ...
                                                   type="checkbox"
                                                   onclick="AllMessages(this.form);" />
                                            <label class="custom-control-label" for="ALLMSGS2">
                                                {__('globalSelectAll')}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-auto">
                                        <div class="input-group"
                                             ...
                                             title='{__('freischaltenMappingDesc')}'>
            ...
            <div id="newscomments" class="tab-pane fade {if $cTab === 'newscomments'} active show{/if}">
                {if count($comments) > 0}
                    ...
                    <div>
                                                ...
                                                <td class="check">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input"
                                                               type="checkbox"
                                                               name="kNewsKommentar[]"
                                                               id="ncid-{$comment->kNewsKommentar}"
                                                               value="{$comment->kNewsKommentar}" />
                                                        <label class="custom-control-label"
                                                               for="ncid-{$comment->kNewsKommentar}"></label>
                                                    </div>
                                                </td>
                                                <td>
                                    ...
                                    <div class="col-sm-6 col-xl-auto text-left">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input"
                                                   ...
                                                   type="checkbox"
                                                   onclick="AllMessages(this.form);" />
                                            <label class="custom-control-label" for="ALLMSGS4">
                                                {__('globalSelectAll')}
                                            </label>
                                        </div>
                                    </div>
                        ...
                        {include file='tpl_inc/pagination.tpl'
                        pagination=$oPagiNewskommentare
                        cAnchor='newscomments'
                        isBottom=true}
                    </div>
                {else}
                    <div class="alert alert-info" role="alert">{__('noDataAvailable')}</div>
            ...
            <div id="newsletter" class="tab-pane fade {if $cTab === 'newsletter'} active show{/if}">
                {if count($recipients) > 0}
                    ...
                    <div>
                                            ...
                                            <tr>
                                                <td class="check">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input"
                                                               type="checkbox"
                                                               name="kNewsletterEmpfaenger[]"
                                                               id="newsletter-recipient-id-{$recipient->kNewsletterEmpfaenger}"
                                                               value="{$recipient->kNewsletterEmpfaenger}" />
                                                        <label class="custom-control-label"
                                                               for="newsletter-recipient-id-{$recipient->kNewsletterEmpfaenger}"></label>
                                                    </div>
                                                </td>
                                    ...
                                    <div class="col-sm-6 col-xl-auto text-left">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input"
                                                   ...
                                                   type="checkbox"
                                                   onclick="AllMessages(this.form);" />
                                            <label class="custom-control-label" for="ALLMSGS5">
                                                {__('globalSelectAll')}
                                            </label>
                                        </div>
                                    </div>
                        ...
                        {include file='tpl_inc/pagination.tpl'
                        pagination=$oPagiNewsletterEmpfaenger
                        cAnchor='newsletter'
                        isBottom=true}
                    </div>
                {else}
